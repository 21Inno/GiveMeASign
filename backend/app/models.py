...
with app.app_context():
    ...
    # create a new sign
    new_sign = Sign(gloss='MANGER', keywords='manger, alimentation, dessert', url='https://corpus-lsfb.be/img/pictures/signe_dbdb6f59d8edcdc7d51135d3f6f62dd4.gif')
    new_sign1 = Sign(gloss='DORMIR', keywords='dormir, dormeur, sommeil', url='https://corpus-lsfb.be/img/pictures/signe_aba4817ea7264d451f611a084563b910.gif')
    new_sign2 = Sign(gloss='COURIR', keywords='courir, course', url='https://corpus-lsfb.be/img/pictures/signe_29457ccb6c819c48e83c53aa4e882c62.gif')
